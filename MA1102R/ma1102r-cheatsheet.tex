...
\end{itemize}
\includegraphics[width=0.32\linewidth]{ma1102r-removable-discontinuity.png}
\includegraphics[width=0.32\linewidth]{ma1102r-infinite-discontinuity.png}
\includegraphics[width=0.32\linewidth]{ma1102r-jump-discontinuity.png}
...
\begin{center}
    Then $c \in D$ is a \textit{critical number} of $f$ if 
    \\* $f'(c) = 0$, or $f'(c)$ does not exist.
\end{center}
\begin{center}
    \textbf{fermat's theorem}
    \\* Suppose $f$ has a local maximum or minimum at $c$.
