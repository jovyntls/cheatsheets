...
\begin{center}
    ...
    \\ {additive inverse}
        ...
        \\* $b$ is an additive inverse of $a \Mod n \Iff b \equiv -a \ (\Mod n)$.
    \\ {multiplicative inverse} 
        \\* $b$ is a multiplicative inverse of $a \Mod n \Iff ab \equiv 1 \ (\Mod n)$.
        \\* If $b, b'$ are multiplicative inverses of $a$, then $b \equiv b' \ (\Mod n)$.
\end{center}
\subsubsection{multiplicative inverse}
\begin{itemize}
    \item $a$ has a multiplicative inverse modulo $n \Iff \gcd(a, n) = 1$.
    \begin{itemize}
