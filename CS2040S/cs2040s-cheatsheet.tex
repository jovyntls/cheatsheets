...
\begin{center}
    ...
    \includegraphics[width=0.5\linewidth]{cs2040s-big-o.png}
    
    $T(n) = \Omega(f(n))$
    \\* if $\exists c, n_0 > 0$ such that for all $n > n_0$, $T(n) \geq cf(n)$
    \includegraphics[width=0.5\linewidth]{cs2040s-big-omega.png}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{MergeSort} - mergeSort first half; mergeSort second half; merge
...
\begin{center}
    ...
    \includegraphics[width=0.7\linewidth]{cs2040s-rebalance-case-1.png}
\end{center}

[case 2] B is  \textbf{left-heavy: right-rotate}
\begin{center}
    $h(L) = h(M) + 1, \quad h(R) = h(M)$
    \includegraphics[width=0.7\linewidth]{cs2040s-rebalance-case-2.png}
\end{center}

[case 3] B is  \textbf{right-heavy: left-rotate(v.left), right-rotate(v)}
\begin{center}
    $h(L) = h(M) - 1, \quad h(R) = h(L)$
    \\* \includegraphics[width=0.7\linewidth]{cs2040s-rebalance-case-3-1.png}
    \\* \includegraphics[width=0.7\linewidth]{cs2040s-rebalance-case-3-2.png}
\end{center}

\subsection{updating nodes after rotation}
\begin{center}
    weights
    \\* \includegraphics[width=0.6\linewidth]{cs2040s-rotate-weights.png}
    
    max
    \\* \includegraphics[width=0.6\linewidth]{cs2040s-rotate-max.png}
\end{center}
...
\end{itemize}
\begin{tightcenter}
    \includegraphics[width=0.6\linewidth]{cs2040s-trie.png}
\end{tightcenter}

\subsection{interval trees}
\begin{tightcenter}
    \includegraphics[width=0.5\linewidth]{cs2040s-interval-tree.png}
\end{tightcenter}
\begin{itemize}
...
\subsection{kd-Tree}
\includegraphics[width=0.8\linewidth]{cs2040s-kdtree.png}
\begin{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item probability of a specific item remaining in its initial position $= \frac{1}{n}$
    \item \textbf{KnuthShuffle}: for every element in array $A$, swap it with a random index in array $A. \Then O(n)$
\end{itemize}
