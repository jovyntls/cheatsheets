...
\begin{multicols*}{3}
  ...
  \begin{itemize}
    ...
    \item register is \definition{atomic} if the implementation always ensures linearisability of the history
    \item register is \definition{sequentially consistent} if the implementation always ensures sequential consistency of the history
    \item register is \definition{regular} when a read
      \begin{itemize}
      ...
      \end{itemize}
    \item register is \definition{safe} if the implementation always ensures that
      \begin{itemize}
