...
\begin{multicols*}{4}
  ...
  % \newcommand{\fbox}[1]{\begin{tightcenter}
  %     \fcolorbox{red}{white}{\parbox{0.9\linewidth}{\color{black}#1}}
  %   \end{tightcenter}}
  ...
  \begin{tightcenter}
    \fbox{\parbox{0.9\linewidth}{\color{black} \begin{tightcenter} 
  ...
  \fbox{\parbox{0.9\linewidth}{\color{black}  
  ...
  \begin{tightcenter}
    \fbox{\parbox{0.5\linewidth}{\color{black} \begin{tightcenter} 
  ...
  \begin{tightcenter}
    \fbox{\parbox{0.94\linewidth}{\begin{tightcenter}\color{black}
          \textbf{covariance}
          \begin{align*}
  ...
  \begin{tightcenter}
    \fbox{\parbox{0.94\linewidth}{\color{black}
        \begin{align*}
  ...
  \begin{tightcenter}
    \scriptsize
    \fbox{\parbox{0.99\linewidth}{\begin{tightcenter}\color{black}
  ...
  \begin{tightcenter}
    \fcolorbox{blue}{white}{\parbox{0.94\linewidth}{\color{black}
  ...
  \begin{tightcenter}
    \fcolorbox{blue}{white}{\parbox{0.94\linewidth}{\begin{tightcenter}\color{black}
  ...
  \begin{tightcenter}
    \begin{tabular}{cc}
      ...
      \end{tightcenter}}}
      &
      \fbox{\parbox{0.37\linewidth}{\begin{tightcenter}\color{black}
  ...
  \begin{tightcenter}
    \fbox{\parbox{0.9\linewidth}{\begin{tightcenter}\color{black}
  ...
  \begin{tightcenter}\fbox{\parbox{0.9\linewidth}{\color{black}
        \begin{tightcenter}
  ...
  \begin{tightcenter}\fcolorbox{blue}{white}{\parbox{0.9\linewidth}{\color{black}\begin{tightcenter}
  ...
  \end{tightcenter} }}\end{tightcenter}
  ...
  \begin{tightcenter}\fbox{\parbox{0.9\linewidth}{\color{black} \begin{tightcenter}
  ...
  \begin{tightcenter}
    \fbox{\parbox{0.92\linewidth}{\color{black} 
        \begin{enumerate}
  ...
  \begin{tightcenter} \fbox{\parbox{0.95\linewidth}{\color{black} 
        \begin{tightcenter}
  ...
  \begin{tightcenter}\fcolorbox{blue}{white}{\parbox{0.8\linewidth}{\color{black}\begin{tightcenter}
...
\end{tightcenter} }} \end{tightcenter}
  ...
  \begin{itemize}
    ...
    \item for large $n$, $\hat p \approx N\left( p, \frac{p^2(1-p)}{n} \right)$
      \begin{itemize}
  ...
  $f(x \vert p) = \frac{1}{\sqrt{2\pi} \sigma} \exp \{ -\frac{(x-\mu)^2}{2\sigma^2} \}, \quad x \in \mathbb{R}$

  \begin{itemize}
    \item $\log f(X \vert p) = \frac{1}{2}\log{2\pi} - \log \sigma - \frac{(x-\mu)^2}{2\sigma^2n}$
      $\qquad = c - \log\sigma - \frac{(X-\mu)^2}{2\sigma^2n}$
    \item differentiate $\frac{d}{dp}$: $\quad \frac{\delta}{\delta \mu} = \frac{X-\mu}{\sigma^2}$,
      $\quad \frac{\delta}{\delta \sigma} = -\frac{1}{\sigma} + \frac{(X-\mu)^2}{\sigma^3}$
    \item differentiate $\frac{d^2}{dp^2}$: 
      $ \begin{bmatrix}
        \frac{\delta^2}{\delta \mu^2} & \frac{\delta^2}{\delta \mu \delta \sigma} \\
        \frac{\delta^2}{\delta\sigma\delta\mu} & \frac{\delta^2}{\delta\sigma^2}
      \end{bmatrix} $
    \item $\mathcal{I}(p) = -E(\frac{d^2\log f(X \vert \theta)}{d\theta^2}) = 
      \begin{bmatrix}
        \frac{1}{\sigma^2} & 0 \\
        0 & \frac{2}{\sigma^2}
      \end{bmatrix}$
  ...
  \begin{tightcenter}
    ...
    $\alpha = P_{H_0} (\Xbar > \mu_0 + c) = \Pr (Z > \frac{c}{\sigma/\sqrt n}) \quad \Rightarrow c = z_\alpha$
  \end{tightcenter}
