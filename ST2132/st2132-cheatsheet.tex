...
\begin{multicols*}{4}
  ...
  \begin{itemize}
    ...
    \item hat ($\hat{\phantom x}$) means estimator (random variable)
      \begin{itemize}
        ...
        \item $\bar x = \frac{1}{n} \sum^n_{i=1} x_i$
      \end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
    \item let $X \sim Poisson(\lambda)$. $\mu_1 = \lambda$. Estimate $\lambda$ by estimating $\mu_1$ using sample mean $\bar x$, which is an estimator of  $\bar X$.
    \item the MOM estimator is $\hat \lambda = \hat{\mu_1} = \bar X$
      \begin{itemize}
        \item the random sample mean
      \end{itemize}
    \item $\var(X) = \lambda$, $\var(\bar X) = \frac{\lambda}{n}$, SE = SD of estimator $= \sqrt \frac{\lambda}{n}$
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item MOM estimator, $\hat p = \hat{\mu_1} = \bar X$
      \begin{itemize}
  ...
  \begin{itemize}
    \item for $X \sim Geometric(p) \quad \Rightarrow E(X) = \frac{1}{p}$
      ...
      \end{itemize}
    \item $\mu_1 = \frac{1}{p} \quad \Rightarrow p = \frac{1}{\mu_1} \quad \Rightarrow \hat p = \frac{1}{\bar X}$
    \item MOM estimator, $\hat p = \frac{1}{\bar X}$
      \begin{itemize}
        \item then MOM estimate $= \frac{1}{\bar x}$
      \end{itemize}
    \item SE = $SD(1/\bar X) \qquad \Rightarrow$ use monte carlo to approximate
  \end{itemize}
